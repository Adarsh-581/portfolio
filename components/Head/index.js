...
export default function DomHead({ pageName = "Home Page" }) {
    ...
    return (
        <Head>
            ...
            {/* meta tags begins */}
            {/* Primary Meta Tags */}
            <meta name="title" content="Adarsh- Personal Portfolio." />
            <meta name="description" content="Generated using BaayMax." />
            {/* Open Graph / Facebook */}
            <meta property="og:type" content="website" />
            <meta property="og:url" content="https://github.com/Adarsh-581" />
            <meta property="og:title" content="Adarsh- Personal Portfolio" />
